module.exports = function middlewareConstructor(env) {
  ...
  return {
    ...
    checkForPublishData: function(req, res, next) {
     ...
     /*
     *check if blacklisted words has been entered
     **/
     blacklistedCheck: function(req, res, next){
      
      //checks tags backlist words
      var htmlOriginal = req.body.html.trim();

      if (typeof htmlOriginal !== "string") {
        htmlOriginal = (htmlOriginal || "").toString();
      }
      console.log("html:"+ htmlOriginal);
      var blacklist = {};
      ...
      if (htmlOriginal.match(blacklist)) {
       //found
